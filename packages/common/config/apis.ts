...
export const apiConfigurations: ReadonlyArray<Readonly<APIConfiguration>> = [
  {
    ...
    getApiContent: () => import('./apis/hcc-insights/insights-advisor/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['rhel'], apiLabelsMap['lightspeed'], apiLabelsMap['observe']],
  },
  {
    ...
    icon: 'AnsibleIcon',
    apiContentPath: './apis/hcc-insights/ansible-automation-controller/content.json',
    serverUrl: 'none',
    getApiContent: () => import('./apis/hcc-insights/ansible-automation-controller/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/automation-hub/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['ansible'], apiLabelsMap['automation']],
  },
  {
    id: 'compliance_v1',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/compliance_v1/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['rhel'], apiLabelsMap['security']],
  },
  {
    id: 'compliance_v2',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/compliance_v2/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['rhel'], apiLabelsMap['security']],
  },
  {
    id: 'cost-management',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/cost-management/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/export-service/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/image-builder/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/integrations/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/launch/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['deploy'], apiLabelsMap['lightspeed'], apiLabelsMap['rhel']],
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/malware-detection/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['observe'], apiLabelsMap['rhel'], apiLabelsMap['security']],
  },
  {
    id: 'inventory',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/inventory/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['inventories'], apiLabelsMap['rhel'], apiLabelsMap['lightspeed']],
  },
  {
    id: 'notifications',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/notifications/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['integrations-and-notifications']],
  },
  {
    id: 'gathering',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/gathering/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/payload_ingress/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['lightspeed']],
  },
  {
    ...
    icon: 'GenericIcon',
    apiContentPath: './apis/hcc-insights/insights-results-aggregator_v1/content.json',
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/insights-results-aggregator_v1/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['infrastructure'], apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['openshift'], apiLabelsMap['workloads']],
  },
  {
    ...
    description: 'Aggregation API for Insights Advisor. Exposes recommendations for single and multiple clusters',
    icon: 'GenericIcon',
    apiContentPath: './apis/hcc-insights/insights-results-aggregator_v2/content.json',
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/insights-results-aggregator_v2/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['infrastructure'], apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['openshift'], apiLabelsMap['workloads']],
  },
  {
    id: 'patch',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/patch/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['security'], apiLabelsMap['rhel'], apiLabelsMap['observe'], apiLabelsMap['lightspeed']],
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/playbook-dispatcher/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/policies/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['ansible'], apiLabelsMap['rhel'], apiLabelsMap['observe'], apiLabelsMap['lightspeed']],
  },
  {
    id: 'remediations',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/remediations/content.json') as unknown as Promise<APIContent>,
    tags: [
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/ros/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['observe'], apiLabelsMap['rhel'], apiLabelsMap['lightspeed']],
  },
  {
    id: 'repositories',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/repositories/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['deploy'], apiLabelsMap['lightspeed'], apiLabelsMap['rhel']],
  },
  {
    id: 'rbac',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/rbac/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/sources/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['identity-and-access-management']],
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/rhsm-subscriptions-v1/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['edge'], apiLabelsMap['inventories'], apiLabelsMap['openshift'], apiLabelsMap['rhel'], apiLabelsMap['subscriptions']],
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/rhsm-subscriptions-v2/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['edge'], apiLabelsMap['inventories'], apiLabelsMap['openshift'], apiLabelsMap['rhel'], apiLabelsMap['subscriptions']],
  },
  {
    id: 'tasks',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/tasks/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['automation'], apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['rhel']],
  },
  {
    id: 'vulnerability',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/vulnerability/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['observe'], apiLabelsMap['security'], apiLabelsMap['rhel'], apiLabelsMap['lightspeed']],
  },
  {
    ...
    serverUrl: 'none',
    getApiContent: () => import('./apis/hcc-insights/ansible-lightspeed/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['ansible'], apiLabelsMap['automation']],
  },
  {
    id: 'roadmap',
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/hcc-insights/roadmap/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['lightspeed'], apiLabelsMap['rhel']],
  },
  {
    ...
    getApiContent: () => import('./apis/openshift/accounts-management-service/content.json') as unknown as Promise<APIContent>,
  ...
  },
  {
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/assisted-install-service/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/authorization-service/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/connector-management/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    icon: 'GenericIcon',
    apiContentPath: './apis/openshift/kafka-service-fleet-manager-service/content.json',
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/kafka-service-fleet-manager-service/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/rhacs-service-fleet-manager/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    id: 'service-logs',
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/service-logs/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/service-registry-management/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    icon: 'GenericIcon',
    apiContentPath: './apis/openshift/upgrades-information-service/content.json',
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/upgrades-information-service/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    ...
    serverUrl: 'https://console.redhat.com',
    getApiContent: () => import('./apis/openshift/ocp-vulnerability/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['lightspeed'], apiLabelsMap['observe'], apiLabelsMap['openshift'], apiLabelsMap['security']],
  },
  {
    id: 'web-rca-service',
    ...
    serverUrl: 'https://api.openshift.com',
    getApiContent: () => import('./apis/openshift/web-rca-service/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['openshift'], apiLabelsMap['infrastructure']],
  },
  {
    id: 'case-management',
    ...
    getApiContent: () => import('./apis/access/case-management/content.json') as unknown as Promise<APIContent>,
    tags: [apiLabelsMap['ansible'], apiLabelsMap['rhel'], apiLabelsMap['openshift']],
  },
];
