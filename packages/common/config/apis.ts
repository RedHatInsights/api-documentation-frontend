...
export const apiConfigurations: ReadonlyArray<Readonly<APIConfiguration>> = [
  ...
  },
  {
    ...
    tags: [apiLabelsMap["spend-management"], apiLabelsMap["lightspeed"]],
  },
  {
    id: "export-service",
  ...
  },
  {
    ...
    tags: [apiLabelsMap["deploy"], apiLabelsMap["lightspeed"]],
  },
  {
    id: "integrations",
  ...
  },
  {
    ...
    displayName: "Red Hat Lightspeed Advisor for OpenShift V1",
    description:
  ...
  },
  {
    ...
    displayName: "Red Hat Lightspeed Advisor for OpenShift V2",
    description:
      "Aggregation API for Insights Advisor. Exposes recommendations for single and multiple clusters",
    icon: "GenericIcon",
    apiContentPath:
